# Relatório Lighthouse — https://codigosintetico.com.br
**Data:** 2026-02-19 12:57:48
...
### Diagnósticos
- **Reduza o JavaScript não usado** — Economia estimada de 25 KiB
  - https://codigosintetico.com.br/_next/static/chunks/966fde57cb8a1de7.js | 69778 | 25306
...
- **As cores de primeiro e segundo plano não têm uma taxa de contraste suficiente.**
  ...
  **Elementos com falha:**
  - `CS` — `<div aria-hidden="true" class="text-[8rem] font-semibold tracking-tighter leading-none text-ink-inverted/…">`
...
- Os elementos de título aparecem em uma ordem sequencial descendente
...
### Diagnósticos
- **Reduza o JavaScript não usado** — Economia estimada de 25 KiB
  - https://codigosintetico.com.br/_next/static/chunks/966fde57cb8a1de7.js | 69802 | 25315

### Auditorias Reprovadas
Nenhuma auditoria reprovada.
...
- A página tem o doctype HTML
- A página tem um código de status HTTP bem-sucedido
- As cores de primeiro e segundo plano têm uma taxa de contraste suficiente
- As funções ARIA descontinuadas não foram usadas
- As listas contêm somente elementos `<li>` e elementos compatíveis com script (`<script>` e `<template>`).
- As áreas de toque têm tamanho e espaçamento suficientes.
- Define corretamente o charset
